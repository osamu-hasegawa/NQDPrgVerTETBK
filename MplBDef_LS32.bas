...
'
'   2005.11.22  s.f    êîílÇÃÇÑÇÉâª
'   2005.11.26  s.f    function ÇÃÅ@å^êÈåæ
'
'
'*************************************************************************************************************************
...
'
'Global Const idc16777216 As Long = 16777216  'Å@ÉIÅ[ÉoÅ[ÉtÉçÅ[ëŒçÙÇ≈í«â¡  2005.11.22                 Ç±ÇÃâ∫4çsPGM_KTDÅ@Ç≈êÈåæ
'Global Const idc8388607 As Long = 8388607  'Å@ÉIÅ[ÉoÅ[ÉtÉçÅ[ëŒçÙÇ≈í«â¡  2005.11.22
'Global Const idc65536  As Long = 65536  'Å@ÉIÅ[ÉoÅ[ÉtÉçÅ[ëŒçÙÇ≈í«â¡Å@Ç±ÇÃâ∫ÇRçsÅ@2005.11.6Å@ÇìÅDÇÜ
...
Dim Cmd%
   ...
   StopFlag = 1
End Sub
Public Function C870Sts%(no%)     '  05.11.26  Åu%ÅvÅ@í«â¡
